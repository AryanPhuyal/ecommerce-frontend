          ...
          <div className="row">
            ...
            <div id="departments-menu" className="dropdown departments-menu">
              ...
              >
                ...
                <li className="highlight menu-item animate-dropdown">
                  <a title="New Arrivals" href="home-v4.html">
                    New Arrivals
                  </a>
                </li>
                <li className="yamm-tfw menu-item menu-item-has-children animate-dropdown dropdown-submenu">
                  <a
                    ...
                    href="#"
                  >
                    Computers &#038; Laptops <span className="caret"></span>
                  </a>
                            ...
                            <div className="kc-col-container">
                              <div className="kc_text_block">
                                <ul>
                                  ...
                                  <li>
                                    <a href="shop.html">
                                      Pen Drives, Hard Drives &amp; Memory Cards
                                    </a>
                                  </li>
                                  <li>
                ...
                <li className="yamm-tfw menu-item menu-item-has-children animate-dropdown dropdown-submenu">
                  <a
                    ...
                    href="#"
                  >
                    Smart Phones &#038; Tablets <span className="caret"></span>
                  </a>
                  <ul role="menu" className=" dropdown-menu">
                    <li className="menu-item menu-item-object-static_block animate-dropdown">
                      <div className="yamm-content">
                ...
                <li className="yamm-tfw menu-item menu-item-has-children animate-dropdown dropdown-submenu">
                  <a
                    ...
                    href="#"
                  >
                    Video Games &#038; Consoles <span className="caret"></span>
                  </a>
                  <ul role="menu" className=" dropdown-menu">
                    <li className="menu-item menu-item-object-static_block animate-dropdown">
                      <div className="yamm-content">
                ...
                <li className="yamm-tfw menu-item menu-item-has-children animate-dropdown dropdown-submenu">
                  <a
                    ...
                    href="#"
                  >
                    Car Electronic &#038; GPS <span className="caret"></span>
                  </a>
                  <ul role="menu" className=" dropdown-menu">
                    <li className="menu-item menu-item-object-static_block animate-dropdown">
                      <div className="yamm-content">
                ...
                <li className="menu-item menu-item-type-custom animate-dropdown">
                  <a title="Gadgets" href="landing-page-v1.html">
                    Gadgets
                  </a>
                </li>
                <li className="menu-item menu-item-type-custom animate-dropdown">
            ...
            {/* .departments-menu */}
            <form className="navbar-search" method="get" action="home-v1.html">
                    ...
                    <div className="widget woocommerce widget_shopping_cart">
                      <div className="widget_shopping_cart_content">
                        ...
                        <p className="woocommerce-mini-cart__buttons buttons">
                          <a href="cart.html" className="button wc-forward">
                            View cart
                          </a>
                          <a
                            href="checkout.html"
            ...
            <div className="row">
              ...
              >
                <ul id="menu-navbar-primary" className="nav yamm">
                  ...
                  <li className="menu-item animate-dropdown">
                    <a title="CAMERAS &amp; PHOTO" href="product-category.html">
                      CAMERAS &#038; PHOTO
                    </a>
                  </li>
                  <li className="menu-item animate-dropdown">
